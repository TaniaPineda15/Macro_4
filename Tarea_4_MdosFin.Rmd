...
plot.1 <- autoplot(ts.dexterna[,2:3], colour = 'blue') + 
...
plot.2 <- autoplot(ts.ds.dexterna[,4:5], colour = 'blue') + 
...
plot.3 <- autoplot(ts.dinterna[,2:3], colour = 'blue') +
...
plot.4 <- autoplot(ts.ds.dinterna[,4:5], colour = 'blue') + 
...
plot.5 <- autoplot(ts.dinternat[,2:3], colour = 'blue') + 
...
plot.6 <- autoplot(ts.ds.dinternat[,4:5], colour = 'blue') +
...
plot.7 <- autoplot(ts.dexternap[,2:3], colour = 'blue') + 
...
plot.8 <- autoplot(ts.ds.dexternap[,4:5], colour = 'blue') + 
...
plot.9 <- autoplot(ts.dinternap[,2:3], colour = 'blue') + 
...
plot.10 <- autoplot(ts.ds.dinternap[,4:5], colour = 'blue') + 
...
plot.11 <- autoplot(x[,2:3], colour = 'blue') + 
...
plot.13 <- autoplot(y[,2:3], colour = 'blue') +
...
plot.15 <- autoplot(xx[,2:3], colour = 'blue') + 
...
plot.17 <- autoplot(yy[,2:3], colour = 'blue') + 
